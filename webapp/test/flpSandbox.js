		...
		services: {
						...
						"groups": [{
							"tiles": [{
								...
								"properties": {
									...
									"targetURL": "#pruebaprojectprueba-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"pruebaprojectprueba-display": {
								"semanticObject": "pruebaprojectprueba",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=prueba.projectprueba",
									"url": sap.ui.require.toUrl("prueba/projectprueba")
								}
							}
						}
					}
